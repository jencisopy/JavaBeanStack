...
public interface ILogManager {
    ...
    <T extends IAppLogRecord> boolean dbWrite(Class<T> logType, String sessionId, String message, String messageInfo, Integer messageNumber, String event, String type, String object);    
